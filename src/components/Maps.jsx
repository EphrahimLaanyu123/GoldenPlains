...
const MapComponent = () => {
  return (
    <div
      className="bg-orange-100 flex flex-col md:flex-row"
      style={{
        minHeight: "80vh",
      }}
    >
      <div className="p-4 md:pl-20 md:pt-16 flex-1">
        <div className="pb-5 text-2xl font-bold text-blue-900">LOCATION</div>
        <iframe
      ...
      <div className="flex flex-col p-4 md:p-0 md:pl-52 md:pt-8 flex-1">
        <div className="text-3xl md:text-7xl font-bold text-blue-900 mt-4 md:mt-0 md:mb-4">
          FIND US!
        </div>
        ...
        <div className="text-xl md:text-4xl text-blue-900 flex space-x-4 md:space-x-8 pt-4 md:pt-8">
          <FaFacebook />
          <AiFillTwitterCircle />
          <RiInstagramFill />
          <IoLogoYoutube />
