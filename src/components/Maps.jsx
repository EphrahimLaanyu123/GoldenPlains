...
const MapComponent = () => {
  return (
    <div className="main-divv bg-orange-100 min-h-screen flex items-center justify-center py-8">
      <div className="container mx-auto p-4 md:p-8 bg-white shadow-lg rounded-lg">
        <div className="flex flex-col md:flex-row myfont">
          <div className="p-4 md:pl-20 md:pt-16 flex-1 flex flex-col items-center md:items-start">
            <div className="pb-5 myfont text-2xl font-bold text-black-900 text-center md:text-left">
              LOCATION
            </div>
            <iframe
              ...
              className="w-full h-100 md:w-[650px] md:h-[500px] lg:w-[700px] lg:h-[750px]"
              style={{ border: 0 }}
              allowFullScreen=""
              loading="lazy"
          ...
          <div className="flex flex-col p-4 md:p-0 md:pl-16 lg:pl-24 md:pt-8 flex-1 items-center md:items-start text-center md:text-left">
            <div className="text-3xl md:text-5xl lg:text-5xl font-bold text-black-900 mt-4 md:mt-0 md:mb-4">
              FIND US!
            </div>
